export const projectData = [{
  ...
  live: 'https://kushwahabhaveshportfolio.netlify.app'
}, {
  image: "/assets/img/Project/fitnessclub.png",
  ...
  image: "/assets/img/Project/DjangoVideochat.png",
...
{
  image: "/assets/img/Project/jokes.png",
  name: 'Random Jokes',
  type: 'javascripts',
...
{
  image: "/assets/img/Project/tempCal.png",
...
{
  image: "/assets/img/Project/contactForm.png",
  name: 'Contact Form',
  type: 'form',
...
{
  image: "/assets/img/Project/thermometer.png",
...
{
  image: "/assets/img/Project/otpgenerator.png",
...
{
  image: "/assets/img/Project/RegistrationFormJava.png",
